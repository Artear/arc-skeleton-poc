    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function refreshSlot(_ref) {
          var ad = _ref.ad,
            ...
            correlator =
              _ref$correlator === undefined ? false : _ref$correlator,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function fetchBids(_ref2) {
          ...
          var ad = _ref2.ad,
            ...
            correlator =
              _ref2$correlator === undefined ? false : _ref2$correlator,
          ...
          var prebidBids = new Promise(function(resolve) {
            if (wrapper.prebid && wrapper.prebid.enabled) {
              ...
              _prebid.queuePrebidCommand.bind(
                _this,
                (0, _prebid.fetchPrebidBids)(
                  ad,
                  id,
                  timeout,
                  adInfo,
        ...
        var ArcAds = (exports.ArcAds = (function() {
          function ArcAds(options) {
            ...
            if (this.dfpId === "") {
              ...
              (0, _gpt.queueGoogletagCommand)(
                _gpt.dfpSettings.bind(this, handleSlotRendered)
              );
          ...
          _createClass(ArcAds, [
            {
              ...
              value: function registerAd(params) {
                var id = params.id,
                  ...
                  adType =
                    _params$adType === undefined ? false : _params$adType,
                  _params$targeting = params.targeting,
                  targeting =
                    _params$targeting === undefined ? {} : _params$targeting,
                  _params$display = params.display,
                  display =
                    _params$display === undefined ? "all" : _params$display,
                  _params$bidding = params.bidding,
                  bidding =
                    _params$bidding === undefined ? false : _params$bidding;
              ...
              based on the order and type of the advertisement. This logic is skipped if adType is not defined. */
                ...
                if (
                  (!targeting.hasOwnProperty("position") ||
                    _typeof(targeting.position) === "object") &&
                  adType !== false
                ) {
                  ...
                  if (
                    ...
                    Object.assign(
                      position,
                      (0, _customTargeting.renamePositionKey)(
                        targeting,
                        position
                      )
                    );
                  } else {
                    var positionParam = Object.assign(targeting, {
                      position: position
                    });
                ...
                if (
                  ...
                  (0, _gpt.queueGoogletagCommand)(
                    this.displayAd.bind(this, params)
                  );
                }
              }
            ...
            },
            {
              ...
              value: function displayAd(_ref) {
                var id = _ref.id,
                  ...
                  _ref$prerender = _ref.prerender,
                  prerender =
                    _ref$prerender === undefined ? null : _ref$prerender;

                var fullSlotName = (0, _gpt.determineSlotName)(
                  this.dfpId,
                  slotName
                );
                var parsedDimensions = !dimensions.length
                  ? null
                ...
                if (sizemap && sizemap.breakpoints && dimensions) {
                  var _prepareSizeMaps = (0, _sizemapping.prepareSizeMaps)(
                      parsedDimensions,
                      sizemap.breakpoints
                    ),
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function(setImmediate) {
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__finally__ = __webpack_require__(
            11
          );
          ...
          Promise.prototype["finally"] =
            __WEBPACK_IMPORTED_MODULE_0__finally__["a" /* default */];
        ...
        }.call(__webpack_exports__, __webpack_require__(8).setImmediate));
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function runResizeEvents(params) {
          ...
          return function() {
            ...
            for (var i = 0; i < breakpoints.length; i++) {
              ...
              if (
                (width > breakpoint &&
                  (width < nextBreakpoint || !nextBreakpoint) &&
                  lastBreakpoint !== breakpoint) ||
                (width === breakpoint && !initialLoad)
              ) {
                lastBreakpoint = breakpoint;
                initialLoad = true;
        ...
        function setResizeListener(params) {
          ...
          resizeListeners[id] = (0, _debounce.debounce)(
            runResizeEvents(params),
            250
          );
